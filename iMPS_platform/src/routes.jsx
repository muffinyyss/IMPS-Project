...
//   { name: "Monitor(CBM)", icon: <i className="fa fa-desktop" />, path: "#",                   allow: ["admin","owner"] },
...
// /** 4) คำนวณเมนูตาม role แล้ว export ออกไปเลย */
// const roles = getRolesFromStorage();             // e.g. ["admin"] | ["Technician"] | []
// // const allRoutes = prune(baseRoutes, roles);

// export function getRoutes(roles) {
//   const r = roles && roles.length ? roles : getRolesFromStorage();
//   return prune(baseRoutes, r);
// }
...
//   return routes;
// }
// export { baseRoutes };         // เผื่ออยากดู/เทสเมนูเต็ม
