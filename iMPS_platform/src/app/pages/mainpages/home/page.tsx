...
export default function Landing() {
  return (
    <div className="tw-min-h-screen tw-bg-white">
      ...
      <nav className="tw-sticky tw-top-0 tw-z-40 tw-bg-white">
        <div className="tw-mx-auto tw-max-w-7xl tw-h-20 tw-grid tw-grid-cols-[1fr_auto_1fr] tw-items-center tw-px-4">
          ...
          <ul className="tw-flex tw-items-center tw-space-x-10 tw-text-gray-700">
            <li><a href="#" className="tw-font-medium hover:tw-text-black">Home</a></li>
            ...
            <li><a href="#" className="tw-font-medium hover:tw-text-black">Dashboard</a></li>
          </ul>
          ...
          <div className="tw-flex tw-justify-end">
            <Button
              ...
              color="gray"
              size="sm"
              className="tw-rounded-full tw-bg-white tw-border tw-border-gray-300 tw-px-5 tw-h-10 tw-shadow-sm"
            >
              Login
            </Button>
          </div>
      ...
      {/* HERO */}
      <section className="tw-mx-auto tw-max-w-7xl tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-10 tw-items-center tw-px-4 tw-pt-10 md:tw-pt-16">
        {/* Left text */}
