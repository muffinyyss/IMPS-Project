...
export default function DCChargerDashboard() {
    ...
    const { LEFT_LIST, RIGHT_LIST, CENTER_LIST, DEVICES } = useMemo(() => {
        ...
        const left: Device[] = [
            ...
            { id: "motor1-l", name: "Motor Starter1", value: String(p.motor_starter1 ?? ""), status: pickStatus(p.motor_starter1, 1, 5), metricType: "times" },
            { id: "motor2-2", name: "Motor Starter2", value: String(p.motor_starter2 ?? ""), status: pickStatus(p.motor_starter2, 1, 5), metricType: "times" },
        ...
        const right: Device[] = [
            ...
            { id: "motor3-3", name: "Motor Starter3", value: String(p.motor_starter3 ?? ""), status: pickStatus(p.motor_starter3, 1, 5), metricType: "times" },
            { id: "motor4-4", name: "Motor Starter4", value: String(p.motor_starter4 ?? ""), status: pickStatus(p.motor_starter4, 1, 5), metricType: "times" },
            { id: "motor5-5", name: "Motor Starter5", value: String(p.motor_starter5 ?? ""), status: pickStatus(p.motor_starter5, 1, 5), metricType: "times" },
