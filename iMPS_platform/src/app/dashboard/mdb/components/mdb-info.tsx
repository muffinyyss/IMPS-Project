        ...
        <div className={`tw-w-full tw-space-y-6 tw-shadow-md${className}`}>
            ...
            <div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-[minmax(0,1fr)_250px] md:tw-gap-6">
                <div className="tw-space-y-3 tw-w-full">
                    <MetricRow
                        icon={
                            <svg
                                ...
                                className="icon icon-tabler icon-tabler-wave-saw-tool tw-text-yellow-600 tw-shadow-md"
                                width="25"
                                height="25"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                    ...
                    />
                    <MetricRow
                        icon={<i className="fa-solid fa-bolt tw-text-yellow-600 tw-h-5 tw-w-5 tw-shadow-md"></i>}
                        label="Power Energy" value={formatComma(powerKW)}
                        unit="kW" />
                    <MetricRow
                        icon={<i className="fas fa-gas-pump tw-text-yellow-600 tw-h-5 tw-w-5 tw-shadow-md"></i>}
                        label="Total Energy"
                        value={formatComma(totalEnergyKWh)}
                        unit="kWh" />
                    <MetricRow
                        icon={
                            <svg xmlns="http://www.w3.org/2000/svg" className="tw-shadow-md icon icon-tabler icon-tabler-waveform tw-text-yellow-600" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                {/* Status Cards */}
                <div className="tw-grid tw-grid-cols-1 md:tw-max-w-[250px] tw-gap-10 tw-shadow-md">
                    <div className="tw-rounded-lg tw-border tw-border-blue-gray-100 tw-bg-white tw-p-5 tw-shadow-md tw-space-y-5">
...
function QuickStat({
    ...
    return (
        <div className="tw-flex tw-items-center tw-gap-3 tw-rounded-lg tw-border tw-border-blue-gray-100 tw-bg-white tw-px-3 tw-py-2 tw-shadow-md">
...
function MetricRow({
    ...
    return (
        <div className="tw-flex tw-items-center tw-gap-3 tw-rounded-md tw-border tw-border-blue-gray-50 tw-bg-white tw-px-3 tw-py-2 tw-shadow-md">
...
function MiniRow({
    ...
    return (
        <>
            ...
            <div className="tw-flex tw-justify-between tw-shadow-md">
                <Typography variant="small" color="blue-gray" className="tw-opacity-70">
                    {rightLabel}
                </Typography>
