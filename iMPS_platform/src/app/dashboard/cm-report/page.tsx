...
//   // อ่านค่าจาก URL (?tab=...) ถ้าไม่มีให้ถือว่าเป็น "Open"
//   const active: TabId = slugToTab(searchParams.get("tab"));

//   // เปลี่ยนแท็บ = อัปเดต query param แล้วคงค่าอื่นๆ เช่น station_id ไว้เหมือนเดิม
//   const handleChange = (v: string) => {
//     const nextTab = v as TabId;
//     const params = new URLSearchParams(searchParams.toString());
//     params.set("tab", tabToSlug(nextTab));
//     // คง station_id เดิมอัตโนมัติ เพราะเราเริ่มจาก searchParams เดิม
...
//   // เปลี่ยนแท็บ = อัปเดต query param (คงพารามิเตอร์อื่น ๆ เช่น station_id ไว้)
//   const go = (next: TabId) => {
//     const params = new URLSearchParams(searchParams.toString());
...
//               key={t.id}
//               value={t.id}
//               onClick={() => go(t.id)}      // << เปลี่ยนมาอัปเดต URL ที่นี่
//               className="
//                 tw-rounded-lg tw-px-5 tw-py-2
//                 tw-text-sm md:tw-text-base tw-font-medium
//                 tw-flex tw-flex-nowrap tw-items-center tw-justify-center tw-gap-2
