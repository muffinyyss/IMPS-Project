...
import CMOpenForm from "@/app/dashboard/cm-report/open/input_CMreport/components/checkList"; // ✅ import ตรง
...
export default function CMReportPage({ token, apiBase = BASE }: Props) {
  ...
  const goAdd = () => setView("form");         // จะได้ .../cm-report?station_id=...&view=form
  const goList = () => setView("list");         // ลบ view ออก = กลับหน้า list
