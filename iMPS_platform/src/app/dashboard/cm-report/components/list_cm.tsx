...
export default function ListCMTables({
  ...
  //       {/* โหมด ADD → แสดงฟอร์ม; โหมด LIST → ตาราง */}
  //       {mode === "add" ? (
  //         <CardBody className="tw-px-3 md:tw-px-4 tw-pb-6">
  //           <CMForm
  //             type={equipmentType}                                  // << ส่งชนิดอุปกรณ์เข้าไป
  //             label={TYPE_META[equipmentType].title.split(" - ")[1] // << หรือจะส่ง subtitle ก็ได้
  //               ?? TYPE_META[equipmentType].subtitle}
