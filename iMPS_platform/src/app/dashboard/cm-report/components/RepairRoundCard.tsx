...
export type RepairRound = {
     ...
     *
     * ⚠️ ระดับใบงาน field ชื่อเดียวกันนี้เป็น string[] ของ laborcode ล้วน ๆ และหมายถึง
     *    "รอบล่าสุดที่ยังไม่ปิด" เท่านั้น — IN09 อ่านตัวในรอบนี้ก่อนเสมอ
     *    (services/cm_maximo.repair_rounds) รอบไหนเลือกใครถึงจะลงเวลาให้คนนั้น
     */
