...
export const AC_TEST_DATA: ACTestItem[] = [
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Left Cover", testNameTh: "ฝาครอบซ้าย", unit: "", tooltip: { th: "วัดค่าความต่อเนื่องระหว่างฝาครอบด้านซ้ายกับกราวด์หลัก ค่าที่ได้ต้องไม่เกิน 0.1 Ω (ถ้ามี)", en: "Measure continuity between left cover and main ground. The value must not exceed 0.1 Ω (if applicable)" } },
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Right Cover", testNameTh: "ฝาครอบขวา", unit: "", tooltip: { th: "วัดค่าความต่อเนื่องระหว่างฝาครอบด้านขวากับกราวด์หลัก ค่าที่ได้ต้องไม่เกิน 0.1 Ω (ถ้ามี)", en: "Measure continuity between right cover and main ground. The value must not exceed 0.1 Ω (if applicable)" } },
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Front Cover", testNameTh: "ฝาครอบหน้า", unit: "", tooltip: { th: "วัดค่าความต่อเนื่องระหว่างฝาครอบด้านหน้ากับกราวด์หลัก ค่าที่ได้ต้องไม่เกิน 0.1 Ω (ถ้ามี)", en: "Measure continuity between front cover and main ground. The value must not exceed 0.1 Ω (if applicable)" } },
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Back Cover", testNameTh: "ฝาครอบหลัง", unit: "", tooltip: { th: "วัดค่าความต่อเนื่องระหว่างฝาครอบด้านหลังกับกราวด์หลัก ค่าที่ได้ต้องไม่เกิน 0.1 Ω (ถ้ามี)", en: "Measure continuity between back cover and main ground. The value must not exceed 0.1 Ω (if applicable)" } },
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Charger Stand", testNameTh: "ขาตั้งเครื่องชาร์จ", unit: "", tooltip: { th: "วัดค่าความต่อเนื่องที่ฐานหรือเสาโครงสร้างของเครื่องอัดประจุไฟฟ้า ค่าที่ได้ต้องไม่เกิน 0.1 Ω (ถ้ามี)", en: "Measure continuity at the base or structural pole of the charger. The value must not exceed 0.1 Ω (if applicable)" } },
  { category: "Electrical Safety", subCategory: "PE.Continuity protective Conductors of Charger", testName: "Pin PE", testNameTh: "Pin PE", unit: "", tooltip: { th: "ตรวจสอบความต่อเนื่องจากขากราวด์ (Pin PE) ที่หัวจ่ายมายังกราวด์หลัก ค่าที่ได้ต้องไม่เกิน 0.1 Ω", en: "Check continuity from the ground pin (Pin PE) at the connector to the main ground. The value must not exceed 0.1 Ω" } },
  ...
  { category: "Electrical Safety", subCategory: "", testName: "RCD type A", testNameTh: "RCD ชนิด A", unit: "mA", tooltip: { th: "จำลองกระแสรั่วไหลชนิดกระแสสลับ (AC) หรือกระแสตรงแบบพัลส์ (Pulse DC) ซึ่งอุปกรณ์ต้องตัดไฟภายในเวลา 300 ms (ถ้ามี)", en: "Simulate AC or pulsating DC leakage current. The device must trip within 300 ms (if applicable)" } },
  { category: "Electrical Safety", subCategory: "", testName: "RCD type F", testNameTh: "RCD ชนิด F", unit: "mA", tooltip: { th: "จำลองสถานการณ์กระแสรั่วไหลชนิดความถี่ผสม ซึ่งอุปกรณ์ต้องตัดไฟภายในเวลา 300 ms (ถ้ามี)", en: "Simulate mixed frequency leakage current scenario. The device must trip within 300 ms (if applicable)" } },
  { category: "Electrical Safety", subCategory: "", testName: "RCD type B", testNameTh: "RCD ชนิด B", unit: "mA", tooltip: { th: "จำลองสถานการณ์กระแสรั่วไหลชนิดกระแสสลับ (AC), กระแสตรงแบบพัลส์ (Pulse DC) หรือกระแสตรง (DC) ซึ่งอุปกรณ์ต้องตัดไฟภายในเวลา 300 ms (ถ้ามี)", en: "Simulate AC, pulsating DC, or smooth DC leakage current scenario. The device must trip within 300 ms (if applicable)" } },
  { category: "Electrical Safety", subCategory: "", testName: "Power standby", testNameTh: "พลังงานขณะสแตนด์บาย", unit: "", tooltip: { th: "วัดค่ากระแสไฟฟ้าทั้ง 3 เฟส ขณะเครื่องเปิดรอใช้งาน (ยังไม่เสียบชาร์จ)", en: "Measure current in all 3 phases while the device is in standby mode (not yet plugged in for charging)" } },
];
