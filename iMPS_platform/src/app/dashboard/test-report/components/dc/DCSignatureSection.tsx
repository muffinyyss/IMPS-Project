...
interface SignatureSectionProps {
  ...
  onSymbolChange?: (symbolType: 'pass' | 'notPass' | 'notTest', checked: boolean) => void;
  onPhaseSequenceChange?: (phaseType: 'L1L2L3' | 'L3L2L1', checked: boolean) => void;
  onResponsibilityChange?: (field: string, person: 'performed' | 'approved' | 'witnessed', value: string) => void;
}
...
const ACSignatureSection: React.FC<SignatureSectionProps> = ({
  ...
  const handleResponsibilityChange = (field: string, person: 'performed' | 'approved' | 'witnessed', value: string) => {
    ...
    <div className="tw-space-y-6 tw-p-4 tw-border tw-border-gray-300 tw-bg-white">
      ...
      <div>
        <div className="tw-mb-3">
          <span className="tw-text-sm tw-font-semibold tw-text-gray-800">Remark</span>
        </div>
          ...
          <div className="tw-grid tw-grid-cols-4 tw-border-t tw-border-gray-800">
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('name', 'performed', e.target.value)}
                crossOrigin=""
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('name', 'approved', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('name', 'witnessed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
          ...
          <div className="tw-grid tw-grid-cols-4 tw-border-t tw-border-gray-800">
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('signature', 'performed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('signature', 'approved', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('signature', 'witnessed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
          ...
          <div className="tw-grid tw-grid-cols-4 tw-border-t tw-border-gray-800">
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('date', 'performed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('date', 'approved', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('date', 'witnessed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
          ...
          <div className="tw-grid tw-grid-cols-4 tw-border-t tw-border-gray-800">
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('company', 'performed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-border-r tw-border-gray-800 tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('company', 'approved', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
            ...
            <div className="tw-p-2">
              <Input
                ...
                onChange={(e) => handleResponsibilityChange('company', 'witnessed', e.target.value)}
                crossOrigin=""
                className="!tw-border-gray-300"
                containerProps={{ className: "!tw-min-w-0 !tw-h-8" }}
                placeholder=""
