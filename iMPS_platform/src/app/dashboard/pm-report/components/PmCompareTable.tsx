 ...
 *
 * ตอนนี้ฟอร์ม PM เหลือด่านเดียว (ตัด Pre-PM ออกแล้ว) — คอมโพเนนต์นี้เหลือไว้
 * แสดงผลแบบอ่านอย่างเดียวให้เอกสารเก่าที่ยังมี rows_pre / photos_pre / summary_pre เท่านั้น
 */
