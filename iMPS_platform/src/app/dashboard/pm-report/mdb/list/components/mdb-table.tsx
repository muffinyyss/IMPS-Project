...
// const PM_TYPE_CODE = "MB"; // ใช้รหัสเดียวกับ MDB
...
//         // ใช้ helper เพื่อเติม station_id และ dl ให้ถูก
//         const { previewHref, downloadHref, isPdfEndpoint } = buildHtmlLinks(url);

//         // ถ้าเป็น /pdf/.../export แต่ยังไม่มี stationId ให้ปิดปุ่มกัน 422
//         const disabled = isPdfEndpoint && !stationId;

//         return (
//           <a
//             href={!disabled ? downloadHref : undefined}
//             target="_blank"
//             rel="noopener noreferrer"
//             onClick={(e) => { if (disabled) e.preventDefault(); }}
//             className={`tw-inline-flex tw-items-center tw-justify-center tw-rounded tw-px-2 tw-py-1
//               ${!disabled ? "tw-text-red-600 hover:tw-text-red-800" : "tw-text-blue-gray-300 tw-cursor-not-allowed"}`}
//             aria-disabled={disabled}
//             title={!disabled ? "Download PDF" : "กรุณาเลือกสถานีก่อน"}
//           >
//             <DocumentArrowDownIcon className="tw-h-5 tw-w-5" />
//             <span className="tw-sr-only">Download PDF</span>
//           </a>
