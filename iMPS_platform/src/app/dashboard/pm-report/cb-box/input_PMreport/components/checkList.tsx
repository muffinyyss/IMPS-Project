...
export default function CBBOXPMForm() {
    ...
    const onFinalSave = async () => {
        ...
        try {
            ...
            const payload = { station_id: stationId, rows, measures: { m5: m5.state }, summary, dropdownQ1, dropdownQ2, ...(summaryCheck ? { summaryCheck } : {}), work_start: workStart, work_finish: workFinish, wonum: searchParams.get("wonum") ?? "", side: "post", report_id: finalReportId };
