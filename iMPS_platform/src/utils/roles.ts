// cs = เปิดใบงาน CM, head_cs = อนุมัติใบที่ cs เปิด
export type UserRole = "owner" | "admin" | "technician" | "cs" | "engineer" | "head_cs" | "planner";
...
export const STAFF_ROLES: UserRole[] = ["technician", "cs", "engineer", "head_cs", "planner"];
...
export const staffChargerPath = (role?: string | null) =>
    ["cs", "head_cs", "planner"].includes((role ?? "").toLowerCase())
        ? "/dashboard/cm-report"
        : "/dashboard/pm-report";
