...
#     # Row 3
#     pdf.set_xy(x + col_cat, y)
#     pdf.cell(col_checklist, h_header, "CCS2", 1, 0, "C")
#     for _ in range(3):
...
TRANSLATIONS = {
    "th": {
        ...
        "testing_topics_safety": "หัวข้อการทดสอบความปลอดภัย (ด้านแหล่งจ่ายไฟ/ด้านอินพุต)",
        "phase_sequence": "ลำดับเฟส",
        "testing_checklist": "รายการตรวจสอบ",
        "test_results": "ผลการทดสอบ (บันทึกเป็น ผ่าน/ไม่ผ่าน) หรือผลลัพธ์เป็นตัวเลข",
        "1st_test": "ครั้งที่ 1",
        "2nd_test": "ครั้งที่ 2",
        "3rd_test": "ครั้งที่ 3",
        "remark": "หมายเหตุ",
        "electrical_safety": "ความปลอดภัยทางไฟฟ้า",
        "pe_continuity": "ความต่อเนื่อง PE",
        "protective": "ตัวนำป้องกัน",
        "conductors_of": "ของ",
        "charger": "เครื่องชาร์จ",
        "left_cover": "ฝาปิดซ้าย",
        "right_cover": "ฝาปิดขวา",
        "front_cover": "ฝาปิดหน้า",
        "back_cover": "ฝาปิดหลัง",
        "pin_pe_h1": "ขา PE H.1",
        "pin_pe_h2": "ขา PE H.2",
        ...
        "power_standby": "กำลังไฟสแตนด์บาย",
        ...
        "photos": "รูปภาพ",
        "nameplate": "ป้ายชื่อ",
        "testing_equipment": "อุปกรณ์ทดสอบ",
        "testing_equipment_nameplate": "ป้ายชื่ออุปกรณ์ทดสอบ",
        "circuit_breaker": "อุปกรณ์ทดสอบ",
        "rcd": "ป้ายชื่ออุปกรณ์ทดสอบ",
        "gun1": "ปืน 1",
        "gun2": "ปืน 2",
    ...
    "en": {
        ...
        "circuit_breaker": "Testing Equipment",
        "rcd": "Testing Equipment Nameplate",
        "gun1": "GUN 1",
        "gun2": "GUN 2",
...
class HTML2PDF(FPDF, HTMLMixin):
    def __init__(self, *args, **kwargs):
        ...
        self.base_font_name = "THSarabun"
        self.show_signature_footer = False
        self.lang = "en"  # เพิ่มตัวแปรเก็บภาษา
...
def _draw_attachments_list_page(pdf: FPDF, base_font: str, issue_id: str, doc: dict) -> List[Tuple[str, str, int, float, float, float, float]]:
    ...
    # หน้าปัจจุบัน + หน้า list (ประมาณ 1-2 หน้า) = หน้าแรกของ PDF แนบ
    # เราจะใช้ 2 pass: วาดก่อน แล้วคำนวณหน้าจริงหลัง output
