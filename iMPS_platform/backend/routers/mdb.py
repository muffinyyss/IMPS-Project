    ...
    pipeline = [
        {
            "$match": {
                "$and": [
                    {"$expr": {"$lte": [{"$convert": {"input": "$PL1N",   "to": "double", "onError": None, "onNull": 150001}}, 150000]}},
                    {"$expr": {"$lte": [{"$convert": {"input": "$PL2N",   "to": "double", "onError": None, "onNull": 150001}}, 150000]}},
                    {"$expr": {"$lte": [{"$convert": {"input": "$PL3N",   "to": "double", "onError": None, "onNull": 150001}}, 150000]}},
                    {"$expr": {"$lte": [{"$convert": {"input": "$PL123N", "to": "double", "onError": None, "onNull": 150001}}, 150000]}},
                ]
            }
        },
        {
