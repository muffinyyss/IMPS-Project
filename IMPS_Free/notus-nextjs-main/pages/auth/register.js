              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form>
                  <div className="relative w-full mb-3">
                    <label
                      className="block uppercase text-blueGray-600 text-xs font-bold mb-2 ml-2"
                  ...
                  <div>
                    <label className="inline-flex items-center cursor-pointer">
                      ...
                      />
                      <span className="ml-2 mt-2 text-sm font-semibold text-blueGray-600">
                  ...
                  <div className="text-center mt-6">
                    <button
                      className="bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                      type="button"
                    >
                      Register
                    </button>
